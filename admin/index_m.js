...
function load(settings, onChange) {
	...
	const mdIds = $('zero-md[manual-render]')
		.map((i, el) => el.getAttribute('id'))
		.get(); // https://stackoverflow.com/a/54392415
				...
				if (fileExists(newFilePath)) {
					...
					$(`
                        <p class='translation-required'>
                            ...
                            The English file is <a target="_blank" href="https://github.com/iobroker-community-adapters/ioBroker.logparser/tree/master/admin${mdFilePath}">located on Github</a>: <code>https://github.com/iobroker-community-adapters/ioBroker.logparser/tree/master/admin${mdFilePath}</code>.
